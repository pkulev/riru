...
| Name          | Version(s) | Description                                          |
|---------------+------------+------------------------------------------------------|
| brev-separate | 1.100      | Hodge podge of macros and combinators                |
| fmt           | 0.8.14     | Combinator Formatting                                |
| getopt-long   | 4.0        | Command line option parsing                          |
| iset          | 2.3.1      | Integer sets                                         |
| matchable     | 1.2        | Hygienic MATCH replacement                           |
| miscmacros    | 1.3        | Various helper macros                                |
| regex         | 2.1        | Compatibility library for old regular expression API |
| srfi1         | 0.5.1      | SRFI-1 list library                                  |
| srfi13        | 0.3.8      | SRFI-13 string library                               |
| srfi14        | 0.2.3      | SRFI-14 character-sets library                       |
| srfi69        | 0.5.3      | SRFI-69 hash-table library                           |
| test          | 1.3        | Yet another testing utility                          |
| utf8          | 3.7.0      | Unicode support                                      |

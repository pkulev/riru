...
[![CI](https://github.com/pkulev/riru/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/pkulev/riru/actions/workflows/ci.yml)
...
| Name         | Version(s)  | Description                                                           |
|--------------+-------------+-----------------------------------------------------------------------|
| baka-mplayer | 2.0.4, 9999 | Cross-platform libmpv-based multimedia player with uncluttered design |
...
** Continuous integration
   ...
   Before committing ebuild changes, run =bb readme:packages= to refresh the
   package table, then =bb readme:packages:check= to verify it is up to date.

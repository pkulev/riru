...
|--------+------------+------------------------------------------|
| cursor | 3.19.13    | Cursor App - AI-first coding environment |
...
| hy       | 1.3.0, 1.3.1 | A LISP dialect running in python                                              |
...
| Name    | Version(s) | Description                                        |
|---------+------------+----------------------------------------------------|
| chicken | 6.0.0      | Scheme interpreter and native Scheme to C compiler |
